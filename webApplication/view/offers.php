<?php
	...
	if(Session::issetValue('OFFER')){
		$offer = Session::getValue('OFFER');
		$nameOfferPicture = Image::base64toImage($offer->imagen, $offer->id->local, PATH_PICTURES);
	}
?>
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<form class="container well" action="<?php echo URL . 'Offers_controller/management'; ?>" method="POST" enctype="multipart/form-data">
			<div class="row marginTop30px">
				<div class="col-xs-12 col-sm-6 col-md-4 col-md-offset-4">
					<?php
						if(isset($nameOfferPicture)){
					?>
					<img alt="Imagen de la oferta" src="<?php echo URL . 'uploads/pictures/'.$nameOfferPicture; ?>" id="offerPicture"/>
					<?php
					}
					?>
				</div>
			...
			<div class="form-group">
				...
				<input type="hidden" name="tenant" class="form-control" id="tenant" value="<?php echo $user->cuenta; ?>" maxlength="450" readonly required/>
			</div>                            
			<div class="row">
				<div class="col-xs-2">
				...
				<div class="col-xs-5">
					<label for="beginning">Inicio oferta: </label>
					<input type="date" name="beginning" class="form-control" id="beginning" value="<?php echo (isset($offer)) ? $offer->inicio : ''; ?>" maxlength="19" required />
				</div>
				<div class="col-xs-5">
					<label for="expiration">Termino oferta: </label>
					<input type="date" name="expiration" class="form-control" id="expiration" value="<?php echo (isset($offer)) ? $offer->expiracion : ''; ?>" maxlength="12" required />
				</div>
			</div>
			<div class="form-group">
				<label for="description">Descripcion: </label>
				<textarea name="description" class="form-control" id="description" placeholder="Descripcion" required ><?php echo (isset($offer)) ? $offer->id->descripcion : ''; ?></textarea>
			</div>
			<div class="row">
				<div class="col-xs-6">
					<label for="image">Imagen: </label>
					<input type="file" id="picture" name="picture" required>
					<p class="help-block">Seleccione una imagen para su offerta.</p>
				</div>
			</div>
			<div class="row marginTop30px">
				<div class="col-xs-6">
		...
		<script type="text/javascript" src="<?php echo PATH_JS; ?>offers.js"></script>
	</body>
</html>
