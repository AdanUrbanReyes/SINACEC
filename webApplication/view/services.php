<?php
	...
	if(Session::issetValue('SERVICE')){
		$service = Session::getValue('SERVICE');
		$nameServicePicture = Image::base64toImage($service->imagen, $service->id->nombre, PATH_PICTURES);
	}
?>
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<form class="container well" action="<?php echo URL . 'Services_controller/management'; ?>" method="POST" enctype="multipart/form-data">
			<div class="row marginTop30px">
				<div class="col-xs-12 col-sm-6 col-md-4 col-md-offset-4">
					<?php
						if(isset($nameServicePicture)){
					?>
					<img alt="Imagen del Servicio" src="<?php echo URL . 'uploads/pictures/'.$nameServicePicture; ?>" id="servicePicture"/>
					<?php
					}
					?>
				</div>
			...
			<div class="row">
				...
				<div class="col-xs-10">
					...
					<input type="text" name="nameService" class="form-control" id="nameService" maxlength="30" value="<?php echo (isset($service)) ? $service->id->nombre : ''; ?>" placeholder="Nombre del servicio" required/>
				</div>
			</div>
			<div class="form-group">
				<label for="description">Descripcion: </label>
				<textarea name="description" class="form-control" id="description" placeholder="Descripcion" required ><?php echo (isset($service)) ? $service->descripcion : ''; ?></textarea>
			</div>
			<div class="row">
				<div class="col-xs-6">
					<label for="image">Imagen: </label>
					<input type="file" id="picture" name="picture" required>
					<p class="help-block">Seleccione una imagen para su servicio.</p>
				</div>
			</div>
			<div class="row marginTop30px">
				<div class="col-xs-6">
