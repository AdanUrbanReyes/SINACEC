...
/**
 * LocalRentadoId generated by hbm2java
 */
public class LocalRentadoId  implements java.io.Serializable {
    ...
    public LocalRentadoId() {
        direccionCentroComercial = Mysql.valorNoSeteadoInt;
    }

    public LocalRentadoId(String local, String centroComercial, int direccionCentroComercial) {
       this.local = local;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LocalRentadoId) ) return false;
		 LocalRentadoId castOther = ( LocalRentadoId ) other; 
